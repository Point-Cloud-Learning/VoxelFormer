...
def get_recognition(init_dim, dims, voxel_size, query_num=50, scalar_attention_num=3, point_embedding_type="Semantic-based", position_encode_type="None-based", quant_size=0.02,
