...
def get_part_seg(init_dim, dims, voxel_size, query_num=50, scalar_attention_num=4, point_embedding_type="Semantic-based", position_encode_type="None-based", quant_size=0.02,
